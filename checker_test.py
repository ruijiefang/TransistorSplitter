...
class JogTest(unittest.TestCase):
    def setUp(self):
        ...
        self.p2_1 = ResultBlock(2, Transistor("p2_1", "", "", "", "", True, 100, 100, 2))
        self.p2_2 = ResultBlock(2, Transistor("p2_2", "", "", "", "", True, 100, 100, 2))
        self.p2_3 = ResultBlock(2, Transistor("p2_3", "", "", "", "", True, 100, 100, 2))
        self.p2_4 = ResultBlock(2, Transistor("p2_4", "", "", "", "", True, 100, 100, 2))
        self.p2_5 = ResultBlock(2, Transistor("p2_5", "", "", "", "", True, 100, 100, 2))

        self.p3_1 = ResultBlock(3, Transistor("p3_1", "", "", "", "", True, 100, 100, 3))
        self.p3_2 = ResultBlock(3, Transistor("p3_2", "", "", "", "", True, 100, 100, 3))
        self.p3_3 = ResultBlock(3, Transistor("p3_3", "", "", "", "", True, 100, 100, 3))
        self.p3_4 = ResultBlock(3, Transistor("p3_4", "", "", "", "", True, 100, 100, 3))
        self.p3_5 = ResultBlock(3, Transistor("p3_5", "", "", "", "", True, 100, 100, 3))

        self.n1_1 = ResultBlock(1, Transistor("n1_1", "", "", "", "", False, 100, 100, 1))
        self.n1_2 = ResultBlock(1, Transistor("n1_2", "", "", "", "", False, 100, 100, 1))
        self.n1_3 = ResultBlock(1, Transistor("n1_3", "", "", "", "", False, 100, 100, 1))
        self.n1_4 = ResultBlock(1, Transistor("n1_4", "", "", "", "", False, 100, 100, 1))
        self.n1_5 = ResultBlock(1, Transistor("n1_5", "", "", "", "", False, 100, 100, 1))

        self.n2_1 = ResultBlock(2, Transistor("n2_1", "", "", "", "", False, 100, 100, 2))
        self.n2_2 = ResultBlock(2, Transistor("n2_2", "", "", "", "", False, 100, 100, 2))
        self.n2_3 = ResultBlock(2, Transistor("n2_3", "", "", "", "", False, 100, 100, 2))
        self.n2_4 = ResultBlock(2, Transistor("n2_4", "", "", "", "", False, 100, 100, 2))
        self.n2_5 = ResultBlock(2, Transistor("n2_5", "", "", "", "", False, 100, 100, 2))

        self.n3_1 = ResultBlock(3, Transistor("n3_1", "", "", "", "", False, 100, 100, 3))
        self.n3_2 = ResultBlock(3, Transistor("n3_2", "", "", "", "", False, 100, 100, 3))
        self.n3_3 = ResultBlock(3, Transistor("n3_3", "", "", "", "", False, 100, 100, 3))
        self.n3_4 = ResultBlock(3, Transistor("n3_4", "", "", "", "", False, 100, 100, 3))
        self.n3_5 = ResultBlock(3, Transistor("n3_5", "", "", "", "", False, 100, 100, 3))
...
class WidthAddTest(unittest.TestCase):
    ...
    def test1(self):
        self.bp1 = ResultBlock(1, self.p1)
        self.bp2 = ResultBlock(2, self.p2)
        self.bp3 = ResultBlock(3, self.p3)
        self.bp4 = ResultBlock(2, self.p4)
        self.bp5 = ResultBlock(2, self.p4)
        self.bp6 = ResultBlock(3, self.p5)
        self.bp7 = ResultBlock(2, self.p5)
        self.bp8 = ResultBlock(3, self.p6)
        self.bp9 = ResultBlock(3, self.p6)
        self.bp10 = ResultBlock(0, None)

        self.bn1 = ResultBlock(1, self.n1)
        self.bn2 = ResultBlock(2, self.n2)
        self.bn3 = ResultBlock(3, self.n3)
        self.bn4 = ResultBlock(3, self.n4)
        self.bn5 = ResultBlock(1, self.n4)
        self.bn6 = ResultBlock(2, self.n5)
        self.bn7 = ResultBlock(3, self.n5)
        self.bn8 = ResultBlock(3, self.n6)
        self.bn9 = ResultBlock(3, self.n6)
        self.bn10 = ResultBlock(0, None)
    ...
    def test2(self):
        ...
        self.bp8 = ResultBlock(3, self.p6)
        self.bp9 = ResultBlock(3, self.p6)
        self.bp10 = ResultBlock(1, self.p6)
    ...
    def test3(self):
        ...
        self.bp3 = ResultBlock(3, self.p3)
        self.bp4 = ResultBlock(2, self.p4)
        self.bp5 = ResultBlock(1, self.p4)
        self.bp6 = ResultBlock(2, self.p5)
        self.bp7 = ResultBlock(2, self.p5)
        self.bp8 = ResultBlock(1, self.p6)
        self.bp9 = ResultBlock(3, self.p6)
        self.bp10 = ResultBlock(0, None)

        self.bn1 = ResultBlock(1, self.n1)
        self.bn2 = ResultBlock(2, self.n2)
        self.bn3 = ResultBlock(2, self.n3)
        self.bn4 = ResultBlock(3, self.n4)
        self.bn5 = ResultBlock(1, self.n4)
        self.bn6 = ResultBlock(1, self.n5)
        self.bn7 = ResultBlock(3, self.n5)
        self.bn8 = ResultBlock(2, self.n6)
        self.bn9 = ResultBlock(3, self.n6)
        self.bn10 = ResultBlock(0, None)
...
class DiffusionBreakTest(unittest.TestCase):
    def setUp(self):
        ...
        self.p0_2 = ResultBlock(0, None)
        self.p0_3 = ResultBlock(0, None)
        self.p0_4 = ResultBlock(0, None)
        ...
        self.n1_4 = ResultBlock(1, Transistor("n1_4", "", "", "", "", False, 100, 100, 1))
        self.n1_5 = ResultBlock(1, Transistor("n1_5", "", "", "", "", False, 100, 100, 1))
        self.n1_6 = ResultBlock(1, Transistor("n1_6", "", "", "", "", False, 100, 100, 1))
        self.n1_7 = ResultBlock(1, Transistor("n1_7", "", "", "", "", False, 100, 100, 1))
        self.n1_8 = ResultBlock(1, Transistor("n1_8", "", "", "", "", False, 100, 100, 1))

        self.n0_1 = ResultBlock(0, None)
        self.n0_2 = ResultBlock(0, None)
        self.n0_3 = ResultBlock(0, None)
        self.n0_4 = ResultBlock(0, None)
